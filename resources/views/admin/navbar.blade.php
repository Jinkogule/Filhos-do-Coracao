            ...
            <ul class="main">
                <li class="desplegable">
                    ...
                    <ul class="grupo-desplegable">
                        ...
                        <li><a class="dropdown-item" href="{{ route('registro_de_crianca') }}">Registrar Criança</a></li>
                        <li><a class="dropdown-item" href="{{ route('registro_de_familia') }}">Registrar Família</a></li>
                        <li><a class="dropdown-item" href="/adocoes-pendentes">Adoções Pendentes</a></li>
                        <li><a class="dropdown-item" href="/candidatos-a-pais">Candidatos a Pais</a></li>
                        <li><hr class="dropdown-divider"></li>
